...
// SendOne 一对一消息发送
func (s *Business) SendOne(ctx context.Context, msg *pb.PushMsgReq) error {
...
// SendRoom 群组消息发送
func (s *Business) SendRoom(ctx context.Context, msg *pb.PushMsg) error {
...
// Sync 消息同步
func (s *Business) Sync(ctx context.Context, roomId string, seq int64) (*pb.SyncResp, error) {
